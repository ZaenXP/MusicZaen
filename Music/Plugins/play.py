...
#        return await app.leave_chat(chat_id)  
    ...
    if audio:
        ...
        mystic = await message.reply_text(f"**🔄 𝗣𝗿𝗼𝗰𝗲𝘀𝘀𝗶𝗻𝗴 𝗔𝘂𝗱𝗶𝗼 𝗚𝗶𝘃𝗲𝗻 𝗕𝘆 {username}**")
        ...
        await LOG_CHAT(message, what)
        query = message.text.split(None, 1)[1]
        mystic = await message.reply_text("**🔄 𝗦𝗲𝗮𝗿𝗰𝗵𝗶𝗻𝗴**")
        try:
...
async def startyuplay(_,CallbackQuery): 
    ...
    if await is_active_chat(chat_id):
        ...
        photo=thumb,
        reply_markup=InlineKeyboardMarkup(buttons),    
        caption=(f"🎥<b>__Playing:__ </b>[{title[:25]}]({url}) \n⏳<b>__Duration:__</b> {duration} \n💡<b>__Info:__</b> [⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{id})\n👤**__Requested by:__** {checking}")
    )   
        os.remove(thumb)
        await CallbackQuery.message.delete()
...
async def popat(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"1️⃣<b>{title1}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{ID1})__</u>\n\n2️⃣<b>{title2}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{ID2})__</u>\n\n3️⃣<b>{title3}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{ID3})__</u>\n\n4️⃣<b>{title4}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{ID4})__</u>\n\n5️⃣<b>{title5}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by](https://t.me/{BOT_USERNAME}?start=info_{ID5})__</u>",   
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return
