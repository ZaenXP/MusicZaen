...
async def popat(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"1️⃣<b>{title1}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by : @ZaenTapibot]?start=info_{ID1})__</u>\n\n2️⃣<b>{title2}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by : @ZaenTapibot]?start=info_{ID2})__</u>\n\n3️⃣<b>{title3}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by : @ZaenTapibot]?start=info_{ID3})__</u>\n\n4️⃣<b>{title4}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by : @ZaenTapibot]?start=info_{ID4})__</u>\n\n5️⃣<b>{title5}</b>\n  ┗  🔗 <u>__[⚡️️️ Powered by : @ZaenTapibot]?start=info_{ID5})__</u>",   
            reply_markup=InlineKeyboardMarkup(buttons),
        )  
        disable_web_page_preview=True
        return
