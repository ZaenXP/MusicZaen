...
def start_pannel():  
    buttons  = [
            ...
            [ 
                InlineKeyboardButton(text="➡️ Channel⬅️", url="https://t.me/GabutSupport"),
                InlineKeyboardButton(text="➡️ Group⬅️", url="https://t.me/GabutSupport")
            ],  
    ]
